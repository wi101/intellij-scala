...
public class ScalaProjectSettingsPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(showAmbiguousImplicitArgumentsCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.show.hints.if.ambiguous.implicit.arguments.found"));
